import { z } from 'zod';
import { CombinedEmailSchema } from '../pages/emailForm/schema/CombinedEmailSchema';
import { JobSchema } from '../pages/workExperience/schema/JobSchema';
import { TocItemSchema } from '../pages/tocEditor/schema/TocSchema';
